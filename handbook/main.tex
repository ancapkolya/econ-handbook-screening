...
\end{tikzpicture}
    \end{center}
        \item Теперь рассмотрим расстановку с двумя магазинами. Они каким-то образом разделят общую протяженность
        отрезка. На каждом из частей отрезка нам выгодно поставить магазин в середину.
                \begin{center}
        \begin{tikzpicture}
\begin{axis}[
            xlabel = \(\text{Местоположение}\),
