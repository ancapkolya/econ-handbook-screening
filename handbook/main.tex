...
\end{mybox}
\section{Безразличный потребитель}
...
\subsubsection{Координаты $TC(E)$}
    \begin{center}
        ...
        \draw[dashed] (460,90) -- (460,10);
        \draw[dashed] (547,90) -- (547,10);
        \draw[dashed] (100,70) -- (547,70);
        \node at (510,17) {\fontsize{12}{0}\selectfont $E^*$};
        \draw[line width=1pt, |-|, black] (460,10) -- (547,10);
        \draw[line width=1pt, |-|, black] (100,90) -- (100,70);
        \draw[line width=1pt, |-|, black] (100,30) -- (100,50);
        \node at (130,80) {\fontsize{12}{0}\selectfont $A$};
        \node at (130,40) {\fontsize{12}{0}\selectfont $B$};
...
\begin{enumerate}
    ...
    \item Отрезки $A$ и $B$ равны, иначе "High-type" выберет $e=0$
\end{enumerate}
